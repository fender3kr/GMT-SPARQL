...
public class ConnectedComponents extends GraphOperation {
	private static final String NAME = "Connected Components";
	...
	public ConnectedComponents(RepositoryConnection connection) throws OperationException {
